...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[width=1.0\linewidth]{mockups_home.pdf}
        \caption{Home view}
        \label{homeMockup}
    \end{subfigure}
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[width=1.0\linewidth]{mockups_blocklist.pdf}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[width=1.0\linewidth]{mockups_blocksdetail.pdf}
        \caption{Block detail view}
        \label{blockDetailMockup}
    \end{subfigure}
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[width=1.0\linewidth]{mockups_address.pdf}
