...
\projectinfo{
  ...
  abstract.en={This work aims to design a system for processing and to explore blockchain of selected cryptocurrencies using IPFS. It was necessary to design a proprietary decentralized and distributed database system that supports simple queries. The solution provides a well-arranged graphical user interface for data visualization as well as RestAPI, which makes it easy to connect to other systems. The benefit of this work is a new view of blockchain processing which opens up new possibilities in its exploring.}, % abstrakt v anglickém jazyce / abstract in english
