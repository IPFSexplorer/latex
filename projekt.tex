...
\projectinfo{
  ...
  keywords.cs={IPFS, decentralizácia, blockchain, cryptocurrecny}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={IPFS, decentralization, blockchain, cryptocurrecny}, % klíčová slova v anglickém jazyce / keywords in english
  ...
  abstract.en={This work aims to design a system for processing blockchain data of selected cryptocurrencies for further exploring using IPFS. In this thesis, we created a proprietary decentralized and distributed database system that supports simple queries. The solution provides a well-arranged graphical user interface for data visualization as well as API, which makes it easy to connect to other systems. The benefit of this work is a new view of blockchain processing which opens up new possibilities in its exploring. }, % abstrakt v anglickém jazyce / abstract in english
...
\extendedabstract{\todo{Do tohoto odstavce bude zapsán výtah (abstrakt) práce v českém (slovenském) jazyce. Cca 3 normostrany}}
