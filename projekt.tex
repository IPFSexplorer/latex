...
\projectinfo{
  ...
  declaration={I declare that this semester project was prepared as an original author’s work under the supervision of Mr. Ing. Vladimír Veselý, PhD. All the relevant information sources, which were used during the preparation of this project, are cited and included in the list of references.},
...
\sloppy
  ...
  % \subfile{03-decentralization}
  \subfile{04-IPFS}
  \subfile{05-design}
  \subfile{06-implementation}
  \subfile{07-testing}
  \subfile{09-benchmarking}
